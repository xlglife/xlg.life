---
{"dg-publish":true,"permalink":"/5-主题/@第二优先级/Obsidian/Obsidian 插件 Columns/","tags":["Obsidian/插件"],"noteIcon":"1","created":"2023-12-25","updated":"2023-12-31"}
---
...
| 格式 | 实时预览 | 设置选项 | 参考语法 |
| --- | --- | --- | --- |
| 标注 Callout | 支持 | 较少 | [[5-主题/@第二优先级/Obsidian/Obsidian 插件 Columns#标注 Callout 格式\|Obsidian 插件 Columns#标注 Callout 格式]] |
| 代码块 Codeblock | 支持 | 完整 | [[5-主题/@第二优先级/Obsidian/Obsidian 插件 Columns#代码块 Codeblock 格式\|Obsidian 插件 Columns#代码块 Codeblock 格式]] |
| 列表 List | 不支持 | 较少 | [[5-主题/@第二优先级/Obsidian/Obsidian 插件 Columns#列表 List 格式\|Obsidian 插件 Columns#列表 List 格式]] |
